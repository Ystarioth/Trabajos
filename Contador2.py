...
def menu():
    ...
    if opcion ==  "1":
        cant_10 = int(input("¿Cuantos billetes de 10 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "2":
        cant_20 = int(input("¿Cuantos billetes de 20 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "3":
        cant_50 = int(input("¿Cuantos billetes de 50 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "4":
        cant_100 = int(input("¿Cuantos billetes de 100 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "5":
        cant_200 = int(input("¿Cuantos billetes de 200 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "6":
        cant_500 = int(input("¿Cuantos billetes de 500 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "7":
        cant_1000 = int(input("¿Cuantos billetes de 1000 hay en la caja?: ")),sleep(2),os.system('clear')
    elif opcion == "8":
        print("Espero que te haya servido , nos vemos."),sleep(2),os.system('clear')
        return opcion
